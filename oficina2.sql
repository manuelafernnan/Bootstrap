...
create table funcionario(
	...
	8)Pesquisar ordem de serviço, placa do veículo, defeito dos veículos que deram entrada na oficina nos dias 
	05 e 07 de dezembro.
	...
	select peca.nome, servicopeca.quantidade from peca 
	inner join servicopeca on peca.codigopeca = servicopeca.codigopeca
	and servicopeca.ordemservico =  1;

	21) Pesquisar nome do cliente, telefone, placa do veículo, ordem de serviço e defeito de todos os serviços
	que ja foram feitos na oficinas.
